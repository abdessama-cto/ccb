...
func Generate(targetDir string, fp *analyzer.ProjectFingerprint, q *Questionnaire) error {
	dirs := []string{
	...
	files := map[string]string{
		filepath.Join(targetDir, "CLAUDE.md"):                                   generateClaudeMD(fp, q),
		...
		filepath.Join(targetDir, "docs", "architecture.md"):                     generateArchitectureMD(fp),
...
func generateClaudeMD(fp *analyzer.ProjectFingerprint, q *Questionnaire) string {
...
func generateArchitectureMD(fp *analyzer.ProjectFingerprint) string {
